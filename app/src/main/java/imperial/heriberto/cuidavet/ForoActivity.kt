...
class ForoActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val botonRegresar: Button = findViewById(R.id.btn_flechaRegresarForo)
        botonRegresar.setOnClickListener{
            var intent: Intent = Intent (this, menuActivity::class.java)
            startActivity(intent)
        }
        val botonForo: Button = findViewById(R.id.btn_foro2)
        botonForo.setOnClickListener{
            var intent: Intent = Intent (this, Foro2_Activity::class.java)
            startActivity(intent)
        }
        val botonTips: Button = findViewById(R.id.btn_tips)
        botonTips.setOnClickListener{
            var intent: Intent = Intent (this, TipsActivity::class.java)
            startActivity(intent)
        }
        val botonHabitos: Button = findViewById(R.id.btn_habitosSaludables)
...
//        falta este de agregar, es el calendario
        val botonGestacion: Button = findViewById(R.id.btn_gestacion)
